...
#print(data)
for record in data:
    pubID = record["custom_fields"]["rdm:pubID"]
    req = f'https://inveniordm.jlab.org/api/records?q=custom_fields.pac\\:pacID:"{proposal_number}"&l=list&p=1&s=10&sort=bestmatch'
    ...
    if res.json()['hits']['total'] == 0:
        ...
        if r.status_code == 201:
            ...
            data = {"receiver": { "community": "03cfbd45-6332-4680-9960-939ed7a2c3b9"},"type": "community-submission"}
