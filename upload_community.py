...
token = "Cd8gCYcE3ytK7t2ZprXycTV21XOjofU63hLHRBfYbgEgZ9R1kw8bJ68VRAlL"
...
for record in data:
    ...
    if res.json()['hits']['total'] == 0:
        ...
        if r.status_code == 201:
            ...
            data = {"receiver": { "community": "7e66a2b4-abc8-4c68-9112-6af65a01b7c4"},"type": "community-submission"}
